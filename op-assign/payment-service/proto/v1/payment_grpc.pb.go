...
type PaymentServiceClient interface {
	...
	ListPayments(ctx context.Context, in *ListPaymentsRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
}
...
func (c *paymentServiceClient) ListPayments(ctx context.Context, in *ListPaymentsRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	out := new(PaymentResponse)
...
type PaymentServiceServer interface {
	...
	ListPayments(context.Context, *ListPaymentsRequest) (*PaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) ListPayments(context.Context, *ListPaymentsRequest) (*PaymentResponse, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "op-assign/payment-service/proto/v1/payment.proto",
}
